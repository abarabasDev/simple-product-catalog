...
## 🚀 Technologie
- **Frontend:** Angular (v20+), Visual Studio Code
- **Backend:** ASP.NET Core Web API (.NET 9), Visual Studio 2022
- **Baza danych:** SQLite w katalogu API\Database
- **Inne:** Swagger, Bootstrap, NPM
...
### 2. Frontend (Angular)
Zbudować projekt poleceniem ng serve pod angular CLI.
